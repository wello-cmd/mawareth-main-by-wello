...
import { Calculator, Banknote, Store, ArrowRight, DoorOpen } from "lucide-react";
...
export const ThreeDoorsSection = () => {
  ...
  const colors = ["bg-emerald", "bg-trust-blue", "bg-gold"];
  const textColors = ["text-emerald", "text-trust-blue", "text-gold"];
