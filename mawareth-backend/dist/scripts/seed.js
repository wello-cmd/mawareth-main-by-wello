...
const generateId = (oldId) => {
    if (!idMap[oldId]) {
        idMap[oldId] = new mongoose_1.default.Types.ObjectId().toString();
    }
    return idMap[oldId];
};
const seedData = () => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield mongoose_1.default.connect(process.env.MONGODB_URI || 'mongodb://localhost:27017/mawareth');
        console.log('MongoDB Connected');
        // Clear existing data
        yield User_1.default.deleteMany({});
        yield Estate_1.default.deleteMany({});
        yield MarketplaceListing_1.default.deleteMany({});
        yield RenovationOffer_1.default.deleteMany({});
        yield BuyoutApplication_1.default.deleteMany({});
        ...
        yield Estate_1.default.insertMany(estatesData);
        ...
        yield MarketplaceListing_1.default.insertMany(listingsData);
        console.log('Marketplace Listings seeded');
        // Renovation Offers
        const renovationData = [
            {
                estateId: generateId('estate_001'),
            ...
            {
                estateId: generateId('estate_003'),
        ...
        yield RenovationOffer_1.default.insertMany(renovationData);
        console.log('Renovation Offers seeded');
